...
import portraitImage from "./IMG_9481-1-.jpg";
				...
				<div className="flex justify-between h-16 items-center">
					...
					<div className="hidden md:flex space-x-8 text-sm font-medium text-slate-600 items-center">
						...
						<button
							...
							className={`hover:text-blue-600 transition-colors ${
								currentView === "services" ? "text-blue-600" : ""
							}`}>
							Detailed Services
						</button>
						<button
			...
			<div className="flex flex-col-reverse lg:flex-row items-center gap-12 lg:gap-16">
				...
				<div className="flex-1 text-center lg:text-left">
					...
					<h1 className="text-4xl md:text-5xl lg:text-7xl font-bold text-slate-900 leading-tight mb-6">
						Building & Scaling <span className="text-blue-600">Reliable</span>{" "}
						Systems.
					</h1>
					<p className="text-lg md:text-xl text-slate-600 leading-relaxed mb-8 max-w-2xl mx-auto lg:mx-0">
						I architect robust backend infrastructures and provide
						mission-critical support for enterprise applications, ensuring
...
const HomeView = ({ setView }: { setView: (v: ViewState) => void }) => (
	<>
		...
		<section
			id="about"
			className="py-20 border-t border-slate-100 bg-white scroll-mt-20">
			<div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
					<div>
						...
						<div className="space-y-4 text-slate-600 leading-relaxed text-base">
							<p>
								With deep experience in backend architecture and application
								support, I bridge the gap between building high-performance
								features and maintaining production-grade reliability.
							</p>
							<p>
								I thrive in environments where system uptime and data integrity
								are paramount. My background includes working with unfamiliar
								codebases, refactoring legacy systems, and scaling multi-tenant
								platforms.
							</p>
						</div>
					</div>
					<div className="grid grid-cols-2 gap-4">
						{[
							...
							<div
								key={i}
								className="p-6 bg-slate-50 rounded-xl border border-slate-200 group hover:border-blue-300 hover:bg-white transition-all">
								<h4 className="font-bold text-slate-900 mb-1 text-sm md:text-base group-hover:text-blue-600">
									{item.label}
								</h4>
		...
		<section
			id="services-preview"
			className="py-20 bg-slate-900 text-white scroll-mt-20">
			<div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
				<div className="mb-16 text-center">
					<h2 className="text-3xl font-bold mb-4">Core Competencies</h2>
					<p className="text-slate-400 max-w-2xl mx-auto">
						Providing end-to-end technical solutions from architecture to
						support.
					</p>
				</div>
				<div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
					{[
						{
							title: "Backend & API",
							desc: "Scalable microservices using PHP/Laravel with a focus on REST principles.",
						},
						{
							title: "Tech Support",
							desc: "Incident resolution and maintaining stability under strict SLAs.",
						},
						{
							title: "Integrations",
							desc: "Seamlessly connecting platforms with third-party payment and messaging APIs.",
						},
					].map((s, i) => (
						<div
							key={i}
							className="p-8 bg-slate-800/50 rounded-2xl border border-slate-700 hover:border-blue-500 transition-colors">
				...
				<div className="text-center">
					<button
						...
						className="text-blue-400 font-semibold hover:text-blue-300 flex items-center justify-center mx-auto group">
		...
		<div className="bg-slate-50 border-b border-slate-200 py-16">
			<div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				<p className="text-xl text-slate-600 max-w-3xl leading-relaxed">
					I provide professional-grade engineering and support services tailored
					for enterprise systems, multi-tenant platforms, and high-growth
		...
		<div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
					...
					<div className="lg:col-span-1">
						<div className="sticky top-24">
							...
							<p className="text-slate-600 text-sm leading-relaxed">
								Building the "brain" of your application with a focus on
						...
						<div className="bg-slate-50 p-8 rounded-2xl border border-slate-200">
							...
							<ul className="space-y-4 text-slate-600">
								<li className="flex gap-4">
									<div className="w-6 h-6 rounded-full bg-blue-100 flex-shrink-0 flex items-center justify-center text-blue-600 font-bold text-xs">
										A
									</div>
									<div>
										<strong>RESTful Principles:</strong> I design APIs that
										follow strict REST patterns, ensuring they are intuitive for
										other developers to consume and integrate.
									</div>
								</li>
								<li className="flex gap-4">
									<div className="w-6 h-6 rounded-full bg-blue-100 flex-shrink-0 flex items-center justify-center text-blue-600 font-bold text-xs">
									...
									<div>
										<strong>Security-First:</strong> Implementing OAuth2, JWT,
										and rigorous request validation to protect sensitive
										enterprise data.
									</div>
								</li>
								<li className="flex gap-4">
									...
									<div>
										<strong>Performance:</strong> Leveraging caching strategies
										with Redis and optimizing background processes for heavy
										computation.
									</div>
								</li>
							</ul>
				...
				<div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
					<div className="lg:col-span-1">
						<div className="sticky top-24">
							...
							<p className="text-slate-600 text-sm leading-relaxed">
								Maintaining the health and reliability of production systems
					...
					<div className="lg:col-span-2 space-y-6">
						<div className="bg-slate-900 p-8 rounded-2xl text-white shadow-xl">
							<h3 className="font-bold mb-4 text-blue-400 uppercase tracking-wide text-sm">
								Support Excellence
							</h3>
							<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
								<div>
									...
									<p className="text-slate-400 text-sm">
										I am used to working within strict Response and Resolution
										timeframes for enterprise clients.
									</p>
								</div>
								<div>
									<h4 className="font-bold mb-2">Log Analysis</h4>
									<p className="text-slate-400 text-sm">
										Deep-diving into system logs to identify root causes and
										prevent recurrence of critical bugs.
									</p>
								</div>
								<div>
									<h4 className="font-bold mb-2">Incident Resolution</h4>
									<p className="text-slate-400 text-sm">
										Rapid response to platform outages, handling stress with a
								...
								<div>
									...
									<p className="text-slate-400 text-sm">
										Ensuring every fix is documented in internal KBs to speed up
										future support tasks.
									</p>
								</div>
							</div>
						</div>
						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
							<div className="p-6 border border-slate-200 rounded-xl hover:border-blue-400 transition-colors">
								...
								<p className="text-slate-600 text-sm">
									Integration of systems like Paystack and various VTU APIs for
									seamless automated billing and collection.
								</p>
							</div>
							<div className="p-6 border border-slate-200 rounded-xl hover:border-blue-400 transition-colors">
								<h4 className="font-bold text-slate-900 mb-2">
								...
								<p className="text-slate-600 text-sm">
									Implementing reliable SMS and notification pipelines using
									providers like Termii and SendGrid.
								</p>
							</div>
							<div className="p-6 border border-slate-200 rounded-xl hover:border-blue-400 transition-colors">
								<h4 className="font-bold text-slate-900 mb-2">
								...
								<p className="text-slate-600 text-sm">
									Linking custom software with existing enterprise resource
							...
							<div className="p-6 border border-slate-200 rounded-xl hover:border-blue-400 transition-colors">
								...
								<p className="text-slate-600 text-sm">
									Developing robust webhook handlers and background jobs to keep
			...
			<div className="mt-24 p-12 bg-blue-50 border border-blue-100 rounded-3xl text-center">
				...
				<p className="text-slate-600 mb-8 max-w-xl mx-auto">
					If you have a specific project or system that needs architectural
					review or dedicated support, let's discuss the technical requirements.
				</p>
				<button
					onClick={() => {
						const el = document.getElementById("contact");
		...
		<div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
			...
			<div className="space-y-8">
				{EXPERIENCE_DATA.map((exp) => (
					<div
						key={exp.id}
						className="relative pl-8 pb-8 border-l border-slate-200 last:pb-0">
		...
		<div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
			...
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
				{PROJECTS_DATA.map((project) => (
					<div
						key={project.id}
						className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden hover:shadow-md transition-shadow group cursor-default">
						<div className="p-6">
			...
			<div className="bg-slate-900 rounded-[2rem] p-8 md:p-16 text-center text-white relative overflow-hidden shadow-2xl">
				<div className="relative z-10">
					<h2 className="text-3xl md:text-5xl font-bold mb-6">
						Let's Build or Support Something{" "}
					...
					<p className="text-slate-400 mb-10 max-w-2xl mx-auto text-base md:text-lg leading-relaxed">
						I am currently available for full-time roles, contracts, and
						systems-focused consulting. If you need a reliable engineer to scale
						your platform, I'd love to hear from you.
					</p>
